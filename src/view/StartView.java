...
public class StartView {
	...
	public static void main(String[] args) {
		...
		Controller.getUser("이백신", 970324);
		
		System.out.println("\n=== 새로운 user insert ===");
		Vaccine vaccine = new Vaccine("화이자", 12, 21, "mRNA", "-90도 ~ -60도", 6);
		Hospital hospital = new Hospital("아산병원", "송파구", 0, 4, 5);
		Users user = new Users(970325, "이백신", 20, "송파구", "20210801", "20210822", vaccine, hospital);
		/**
		 * ***백신 접종 일자의 경우 
		 * 1. 오늘 이후의 날로 1차 접종일을 입력하면
		 * 2. 자동으로 2차 접종일 계산해서 넣도록 메소드 사용
		 * 
		 * ***새로운 예약이 insert 되면,
		 * 해당 병원의 해당 백신 수 -1;
		 */
		 ...
		 * 		- 예약 변경 일자가 오늘 이후가 맞는지
		 * 		- *** 1차 접종일로부터 얼마나 먼지 확인해서 안되게하는 제약 조건 필요!!
		 */
...
//		
////		System.out.println("1) 1차 예약 수정 선택, 2차 날짜보다 다음 날짜 입력");
