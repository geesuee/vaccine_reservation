...
//			e.printStackTrace();
	...
	public static Vaccine getVaccine(String vaccinName) {
		...
		try {
			vaccine = (Vaccine) em.createNamedQuery("Vaccine.findByVaccineName").setParameter("name", vaccinName)
					.getSingleResult();
		} catch (Exception e) {
//			e.printStackTrace();
		} finally {
	...
	public static List<Vaccine> getVaccineByTargetAge(int targetAge) {
		...
		try {
			vaccineList = em.createNamedQuery("Vaccine.findByVaccineTargetAge").setParameter("target_age", targetAge)
					.getResultList();
		} catch (Exception e) {
//			e.printStackTrace();
		} finally {
